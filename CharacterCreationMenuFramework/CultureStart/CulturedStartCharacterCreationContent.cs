...
namespace CharacterCreationMenuFramework.CultureStart
{
    public class CulturedStartCharacterCreationContent : SandboxCharacterCreationContent
    {
        public void AddTestMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart03}Native", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(NativeOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart04}Native start Menus", null));
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart05}Random", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(RandomOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart06}Auto select random choices", null));
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart05}Packages", null), new List<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(PackagesOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart06}Select from packages", null));
