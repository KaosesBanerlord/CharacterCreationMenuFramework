...
namespace CharacterCreationMenuFramework.NativeMenus
{
    public class FamilyMenu : ICustomMenu
    {
        ...
        public TextObject title => new TextObject("{=b4lDDcli}Kaoses Family");
        *//*        private TextObject _title = new TextObject("{=b4lDDcli}Kaoses Family");
                public TextObject title { get => _title; set => _title = value }*//*

        public TextObject description => new TextObject("{=XgFU1pCx}You were born into a family of...");
        public MenuTypes.menuOperationMode OperationMode => MenuTypes.menuOperationMode.New;
        ...
        public void BuildFamilyMenuOptions(CharacterCreation characterCreation, KaosesStoryModeCharacterCreationContent characterCreationContent)
        {
            ...
            menulandlordsRetainers.effectedSkills = new MBList<SkillObject>(){
                                            DefaultSkills.Riding,
                                            DefaultSkills.Polearm}; //MBList<SkillObject>
            ...
            menuUrbanmerchants.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Trade,
                    DefaultSkills.Charm
                  }; //MBList<SkillObject>
            ...
            menuFreeholders.effectedSkills = new MBList<SkillObject>()
                  {
            ...
            menuUrbanArtisans.effectedSkills = new MBList<SkillObject>()
                  {
            ...
            menuForesters.effectedSkills = new MBList<SkillObject>()
                  {
            ...
            menuUrbanVagabonds.effectedSkills = new MBList<SkillObject>()
                  {
            ...
            _menu.AddRestrictedOptions(new CharacterCreationOnCondition(this.EmpireParentsOnCondition), empireOptinonsList);
            #endregion
            ...
            menuVladianbaronsRetainers.effectedSkills = new MBList<SkillObject>()
                      {
                        DefaultSkills.Riding,
                        DefaultSkills.Polearm
                      }; //MBList<SkillObject>
            ...
            menuVladianUrbanMerchants.effectedSkills = new MBList<SkillObject>()
                      {
                        DefaultSkills.Trade,
                        DefaultSkills.Charm
                      }; //MBList<SkillObject>
            ...
            menuVladianYeomen.effectedSkills = new MBList<SkillObject>()
                      {
                        DefaultSkills.Polearm,
                        DefaultSkills.Crossbow
                      }; //MBList<SkillObject>
            ...
            menuVladianUrbanBlacksmith.effectedSkills = new MBList<SkillObject>()
                      {
                        DefaultSkills.Crafting,
            ...
            menuVladianHunters.effectedSkills = new MBList<SkillObject>()
                      {
                        DefaultSkills.Scouting,
                        DefaultSkills.Crossbow
                      }; //MBList<SkillObject>
            ...
            menuVladianMercenaries.effectedSkills = new MBList<SkillObject>()
                      {
                        DefaultSkills.Roguery,
                        DefaultSkills.Crossbow
                      }; //MBList<SkillObject>
            ...
            _menu.AddRestrictedOptions(new CharacterCreationOnCondition(this.VlandianParentsOnCondition), vlandianOptinonsList);
            ...
            menuBoyarsCompanions.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Riding,
                    DefaultSkills.TwoHanded
                  }; //MBList<SkillObject>
            ...
            menuSturgianUrbanTraders.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Trade,
            ...
            menuSturgianFreeFarmers.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Athletics,
                    DefaultSkills.Polearm
                  }; //MBList<SkillObject>
            ...
            menuSturgianUrbanArtisans.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Crafting,
            ...
            menuSturgianHunters.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Scouting,
                    DefaultSkills.Bow
                  }; //MBList<SkillObject>
            ...
            menuSturgianVagabonds.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Roguery,
                    DefaultSkills.Throwing
                  }; //MBList<SkillObject>
            ...
            _menu.AddRestrictedOptions(new CharacterCreationOnCondition(this.SturgianParentsOnCondition), SturgianOptinonsList);
            #endregion
            ...
            menuKinsfolkofanEmir.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Riding,
                    DefaultSkills.Throwing
                  }; //MBList<SkillObject>
            ...
            menuWarriorSlaves.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Riding,
                    DefaultSkills.Polearm
                  }; //MBList<SkillObject>
            ...
            menuAseraiUrbanMerchants.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Trade,
                    DefaultSkills.Charm
                  }; //MBList<SkillObject>
            ...
            menuOasisFarmers.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Athletics,
                    DefaultSkills.OneHanded
                  }; //MBList<SkillObject>
            ...
            menuBedouin.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Scouting,
                    DefaultSkills.Bow
                  }; //MBList<SkillObject>
            ...
            menuAseraiBackAlleyThugs.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Roguery,
                    DefaultSkills.Polearm
                  }; //MBList<SkillObject>
            ...
            _menu.AddRestrictedOptions(new CharacterCreationOnCondition(this.AseraiParentsOnCondition), AseraiOptinonsList);
            #endregion
            ...
            menuchieftainsHearthguard.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.TwoHanded,
                    DefaultSkills.Bow
                  }; //MBList<SkillObject>
            ...
            menuHealers.effectedSkills = new MBList<SkillObject>()
                  {
            ...
            menuTribespeople.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Athletics,
                    DefaultSkills.Throwing
                  }; //MBList<SkillObject>
            ...
            menuBattaniaSmiths.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Crafting,
                    DefaultSkills.TwoHanded
                  }; //MBList<SkillObject>
            ...
            menuBattaniaForesters.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Scouting,
                    DefaultSkills.Tactics
                  }; //MBList<SkillObject>
            ...
            menuBards.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Roguery,
                    DefaultSkills.Charm
                  }; //MBList<SkillObject>
            ...
            _menu.AddRestrictedOptions(new CharacterCreationOnCondition(this.BattanianParentsOnCondition), BattaniaOptinonsList);
            #endregion
            ...
            menuNoyansKinsfolk.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Riding,
                    DefaultSkills.Polearm
                  }; //MBList<SkillObject>
            ...
            menuKhuzaitMerchants.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Trade,
                    DefaultSkills.Charm
                  }; //MBList<SkillObject>
            ...
            menuKhuzaitTribespeople.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Bow,
                    DefaultSkills.Riding
                  }; //MBList<SkillObject>
            ...
            menuKhuzaitFarmers.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Polearm,
                    DefaultSkills.Throwing
                  }; //MBList<SkillObject>
            ...
            menuKhuzaitShamans.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Medicine,
                    DefaultSkills.Charm
                  }; //MBList<SkillObject>
            ...
            menuKhuzaitNomads.effectedSkills = new MBList<SkillObject>()
                  {
                    DefaultSkills.Scouting,
                    DefaultSkills.Riding
                  }; //MBList<SkillObject>
            ...
            _menu.AddRestrictedOptions(new CharacterCreationOnCondition(this.KhuzaitParentsOnCondition), KhuzaitOptinonsList);
            #endregion
            ...
            characterCreation.ChangeFaceGenChars(new List<FaceGenChar>()
      {
        ...
        protected bool EmpireParentsOnCondition() => CharacterCreationMenuFramework.SubModule.CharacterCreation.GetSelectedCulture().StringId == "empire";

        protected bool VlandianParentsOnCondition() => CharacterCreationMenuFramework.SubModule.CharacterCreation.GetSelectedCulture().StringId == "vlandia";

        protected bool SturgianParentsOnCondition() => CharacterCreationMenuFramework.SubModule.CharacterCreation.GetSelectedCulture().StringId == "sturgia";

        protected bool AseraiParentsOnCondition() => CharacterCreationMenuFramework.SubModule.CharacterCreation.GetSelectedCulture().StringId == "aserai";

        protected bool BattanianParentsOnCondition() => CharacterCreationMenuFramework.SubModule.CharacterCreation.GetSelectedCulture().StringId == "battania";

        protected bool KhuzaitParentsOnCondition() => CharacterCreationMenuFramework.SubModule.CharacterCreation.GetSelectedCulture().StringId == "khuzait";
        #endregion

        protected void FinalizeParents(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.FinalizeParents();

        #region Empire on consequence
        protected void EmpireLandlordsRetainerOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 1, KaosesStoryModeCharacterCreationContent.OccupationTypes.Retainer);
        protected void EmpireMerchantOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 2, KaosesStoryModeCharacterCreationContent.OccupationTypes.Merchant);
        protected void EmpireArtisanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 4, KaosesStoryModeCharacterCreationContent.OccupationTypes.Artisan);
        protected void EmpireWoodsmanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 5, KaosesStoryModeCharacterCreationContent.OccupationTypes.Hunter);
        protected void EmpireVagabondOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 6, KaosesStoryModeCharacterCreationContent.OccupationTypes.Vagabond);
        protected void EmpireFreeholderOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 3, KaosesStoryModeCharacterCreationContent.OccupationTypes.Farmer);


        #endregion

        #region Vladian on consequence
        protected void VlandiaBaronsRetainerOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 1, KaosesStoryModeCharacterCreationContent.OccupationTypes.Retainer);
        protected void VlandiaMerchantOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 2, KaosesStoryModeCharacterCreationContent.OccupationTypes.Merchant);
        protected void VlandiaYeomanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 3, KaosesStoryModeCharacterCreationContent.OccupationTypes.Farmer);
        protected void VlandiaBlacksmithOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 4, KaosesStoryModeCharacterCreationContent.OccupationTypes.Artisan);
        protected void VlandiaHunterOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 5, KaosesStoryModeCharacterCreationContent.OccupationTypes.Hunter);
        protected void VlandiaMercenaryOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 6, KaosesStoryModeCharacterCreationContent.OccupationTypes.Mercenary);
        #endregion

        #region Sturgian on consequence
        protected void SturgiaBoyarsCompanionOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 1, KaosesStoryModeCharacterCreationContent.OccupationTypes.Retainer);
        protected void SturgiaTraderOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 2, KaosesStoryModeCharacterCreationContent.OccupationTypes.Merchant);
        protected void SturgiaFreemanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 3, KaosesStoryModeCharacterCreationContent.OccupationTypes.Farmer);
        protected void SturgiaArtisanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 4, KaosesStoryModeCharacterCreationContent.OccupationTypes.Artisan);
        protected void SturgiaHunterOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 5, KaosesStoryModeCharacterCreationContent.OccupationTypes.Hunter);
        protected void SturgiaVagabondOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 6, KaosesStoryModeCharacterCreationContent.OccupationTypes.Vagabond);
        #endregion

        #region Aserai on consequence
        protected void AseraiTribesmanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 1, KaosesStoryModeCharacterCreationContent.OccupationTypes.Retainer);
        protected void AseraiWariorSlaveOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 2, KaosesStoryModeCharacterCreationContent.OccupationTypes.Mercenary);
        protected void AseraiMerchantOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 3, KaosesStoryModeCharacterCreationContent.OccupationTypes.Merchant);
        protected void AseraiOasisFarmerOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 4, KaosesStoryModeCharacterCreationContent.OccupationTypes.Farmer);
        protected void AseraiBedouinOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 5, KaosesStoryModeCharacterCreationContent.OccupationTypes.Herder);
        protected void AseraiBackAlleyThugOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 6, KaosesStoryModeCharacterCreationContent.OccupationTypes.Artisan);
        #endregion

        #region Khuzait on consequence
        protected void KhuzaitNoyansKinsmanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 1, KaosesStoryModeCharacterCreationContent.OccupationTypes.Retainer);
        protected void KhuzaitMerchantOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 2, KaosesStoryModeCharacterCreationContent.OccupationTypes.Merchant);
        protected void KhuzaitTribesmanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 3, KaosesStoryModeCharacterCreationContent.OccupationTypes.Herder);
        protected void KhuzaitFarmerOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 4, KaosesStoryModeCharacterCreationContent.OccupationTypes.Farmer);
        protected void KhuzaitShamanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 5, KaosesStoryModeCharacterCreationContent.OccupationTypes.Healer);
        protected void KhuzaitNomadOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 6, KaosesStoryModeCharacterCreationContent.OccupationTypes.Herder);
        #endregion

        #region Battania on consequence
        protected void BattaniaChieftainsHearthguardOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 1, KaosesStoryModeCharacterCreationContent.OccupationTypes.Retainer);
        protected void BattaniaHealerOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 2, KaosesStoryModeCharacterCreationContent.OccupationTypes.Healer);
        protected void BattaniaTribesmanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 3, KaosesStoryModeCharacterCreationContent.OccupationTypes.Farmer);
        protected void BattaniaSmithOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 4, KaosesStoryModeCharacterCreationContent.OccupationTypes.Artisan);
        protected void BattaniaWoodsmanOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 5, KaosesStoryModeCharacterCreationContent.OccupationTypes.Hunter);
        protected void BattaniaBardOnConsequence(CharacterCreation characterCreation) => CharacterCreationMenuFramework.SubModule.CharacterCreation.SetParentAndOccupationType(characterCreation, 6, KaosesStoryModeCharacterCreationContent.OccupationTypes.Bard);
