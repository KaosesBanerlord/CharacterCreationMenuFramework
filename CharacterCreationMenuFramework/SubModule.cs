...
namespace CharacterCreationMenuFramework
{
    /// <summary>
    /// CharacterCreationMenuFramework Mod
    /// </summary>
    public class SubModule : MBSubModuleBase
    {
        public const bool UsesHarmony = true;
        public const string ModuleId = "KaosesCCMF";
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        public override void OnNewGameCreated(Game game, object initializerObject)
        {
            ...
            //KaosesStoryModeCharacterCreationContent KaosesStoryMode = CharacterCreation.Instance;
            //Factory.KaosesCharacterCreation = KaosesStoryMode;




            //StoryModeGameManager : SandBoxGameManager

            //GameState KaosesStoryMode = MBGameManager.Current.Game.GameStateManager.CreateState<CharacterCreationState>((object)new KaosesStoryModeCharacterCreationContent());

            //SandBoxGameManager : MBGameManager
            //MBGameManager.Current.Game.GameStateManager.CleanAndPushState(KaosesStoryMode);
            //Game.Current.GameStateManager.CleanAndPushState((TaleWorlds.Core.GameState)Game.Current.GameStateManager.);


            IM.MessageDebug("GameStates: " + Game.Current.GameStateManager.GameStates.ToString());
            //Game.Current.GameStateManager.
            //Game.Current.GameStateManager.GameStates.
            foreach (GameState gs in Game.Current.GameStateManager.GameStates)
            {

                IM.MessageDebug("GameStates: GetName" + gs.GetName().ToString() + "  Id: " + gs.Id.ToString() + " GetType: " + gs.GetType().ToString());
            }
            ...
            {
                //IM.MessageDebug(" StringId: " + objectType.StringId + " GetName: " + objectType.GetName() + "  IsMainCulture: " + objectType.IsMainCulture);
            }
        }
