...
namespace CharacterCreationMenuFramework.NewFolder
{
    ...
    public class KaosesSandboxCharacterCreationContent : CharacterCreationContentBase
    {
        ...
        protected readonly Dictionary<string, Vec2> _startingPoints = new Dictionary<string, Vec2>()
    {
      ...
      },
      {
        ...
        protected KaosesSandboxCharacterCreationContent.SandboxAgeOptions _startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.YoungAdult;
        protected KaosesSandboxCharacterCreationContent.OccupationTypes _familyOccupationType;
      ...
      this.AttributeLevelToAdd,
      (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.EmpireMerchantOnConsequence),
      new CharacterCreationApplyFinalEffects(this.EmpireMerchantOnApply),
      new TextObject("{=FQntPChs}Your family were merchants in one of the main cities of the Empire. They sometimes organized caravans to nearby towns, and discussed issues in the town council."));
      ...
      this.FocusToAdd, this.SkillLevelToAdd,
      this.AttributeLevelToAdd, (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.EmpireFreeholderOnConsequence),
      new CharacterCreationApplyFinalEffects(this.EmpireFreeholderOnApply),
      new TextObject("{=09z8Q08f}Your family were small farmers with just enough land to feed themselves and make a small profit. People like them were the pillars of the imperial rural economy, as well as the backbone of the levy."));
      ...
      this.AttributeLevelToAdd,
      (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.EmpireArtisanOnConsequence),
      ...
      this.FocusToAdd, this.SkillLevelToAdd,
      this.AttributeLevelToAdd, (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.EmpireWoodsmanOnConsequence),
      ...
      this.AttributeLevelToAdd,
      (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.EmpireVagabondOnConsequence),
      ...
      this.AttributeLevelToAdd,
      (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.VlandiaMerchantOnConsequence),
      ...
      this.FocusToAdd, this.SkillLevelToAdd,
      this.AttributeLevelToAdd, (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.VlandiaYeomanOnConsequence),
      ...
      this.AttributeLevelToAdd,
      (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.VlandiaBlacksmithOnConsequence),
      ...
      this.AttributeLevelToAdd,
      (CharacterCreationOnCondition)null,
      new CharacterCreationOnSelect(this.VlandiaHunterOnConsequence),
      ...
      new TextObject("{=yYhX6JQC}Your father joined one of Vlandia's many mercenary companies, composed of men who got such a taste for war in their lord's service that they never took well to peace. Their crossbowmen were much valued across Calradia. Your mother was a camp follower, taking you along in the wake of bloody campaigns."));
        ...
        protected void AddChildhoodMenu(CharacterCreation characterCreation)
        {
            ...
            int skillLevelToAdd1 = this.SkillLevelToAdd;
            int attributeLevelToAdd1 = this.AttributeLevelToAdd;
            CharacterCreationOnSelect onSelect1 = new CharacterCreationOnSelect(KaosesSandboxCharacterCreationContent.ChildhoodYourLeadershipSkillsOnConsequence);
            CharacterCreationApplyFinalEffects onApply1 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.ChildhoodGoodLeadingOnApply);
            ...
            int skillLevelToAdd2 = this.SkillLevelToAdd;
            int attributeLevelToAdd2 = this.AttributeLevelToAdd;
            CharacterCreationOnSelect onSelect2 = new CharacterCreationOnSelect(KaosesSandboxCharacterCreationContent.ChildhoodYourBrawnOnConsequence);
            CharacterCreationApplyFinalEffects onApply2 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.ChildhoodGoodAthleticsOnApply);
            ...
            int skillLevelToAdd3 = this.SkillLevelToAdd;
            int attributeLevelToAdd3 = this.AttributeLevelToAdd;
            CharacterCreationOnSelect onSelect3 = new CharacterCreationOnSelect(KaosesSandboxCharacterCreationContent.ChildhoodAttentionToDetailOnConsequence);
            CharacterCreationApplyFinalEffects onApply3 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.ChildhoodGoodMemoryOnApply);
            ...
            int skillLevelToAdd4 = this.SkillLevelToAdd;
            int attributeLevelToAdd4 = this.AttributeLevelToAdd;
            CharacterCreationOnSelect onSelect4 = new CharacterCreationOnSelect(KaosesSandboxCharacterCreationContent.ChildhoodAptitudeForNumbersOnConsequence);
            CharacterCreationApplyFinalEffects onApply4 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.ChildhoodGoodMathOnApply);
            ...
            int skillLevelToAdd5 = this.SkillLevelToAdd;
            int attributeLevelToAdd5 = this.AttributeLevelToAdd;
            CharacterCreationOnSelect onSelect5 = new CharacterCreationOnSelect(KaosesSandboxCharacterCreationContent.ChildhoodWayWithPeopleOnConsequence);
            CharacterCreationApplyFinalEffects onApply5 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.ChildhoodGoodMannersOnApply);
            ...
            int skillLevelToAdd6 = this.SkillLevelToAdd;
            int attributeLevelToAdd6 = this.AttributeLevelToAdd;
            CharacterCreationOnSelect onSelect6 = new CharacterCreationOnSelect(KaosesSandboxCharacterCreationContent.ChildhoodSkillsWithHorsesOnConsequence);
            CharacterCreationApplyFinalEffects onApply6 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.ChildhoodAffinityWithAnimalsOnApply);
        ...
        protected void AddEducationMenu(CharacterCreation characterCreation)
        {
            ...
            CharacterCreationApplyFinalEffects onApply1 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.RuralAdolescenceHerderOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply2 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.RuralAdolescenceSmithyOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply3 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.RuralAdolescenceRepairmanOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply4 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.RuralAdolescenceGathererOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply5 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.RuralAdolescenceHunterOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply6 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.RuralAdolescenceHelperOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply7 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceWatcherOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply8 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceGangerOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply9 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply10 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceMarketerOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply11 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceMarketerOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply12 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply13 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply14 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply);
            ...
            CharacterCreationApplyFinalEffects onApply15 = new CharacterCreationApplyFinalEffects(KaosesSandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply);
            ...
            creationCategory.AddCategoryOption(text12, effectedSkills12, social, focusToAdd12, skillLevelToAdd12, attributeLevelToAdd12, (CharacterCreationOnCondition)null, onSelect12, onApply12, descriptionText12, new List<TraitObject>()
      {
        ...
        protected void AddAgeSelectionMenu(CharacterCreation characterCreation)
        {
            ...
            CharacterCreationCategory creationCategory = menu.AddMenuCategory();
            creationCategory.AddCategoryOption(new TextObject("{=!}20"), new List<SkillObject>(), (CharacterAttribute)null, 0, 0, 0, (CharacterCreationOnCondition)null, new CharacterCreationOnSelect(this.StartingAgeYoungOnConsequence), new CharacterCreationApplyFinalEffects(this.StartingAgeYoungOnApply), new TextObject("{=2k7adlh7}While lacking experience a bit, you are full with youthful energy, you are fully eager, for the long years of adventuring ahead."), unspentFocusPoint: 2, unspentAttributePoint: 1);
            creationCategory.AddCategoryOption(new TextObject("{=!}30"), new List<SkillObject>(), (CharacterAttribute)null, 0, 0, 0, (CharacterCreationOnCondition)null, new CharacterCreationOnSelect(this.StartingAgeAdultOnConsequence), new CharacterCreationApplyFinalEffects(this.StartingAgeAdultOnApply), new TextObject("{=NUlVFRtK}You are at your prime, You still have some youthful energy but also have a substantial amount of experience under your belt. "), unspentFocusPoint: 4, unspentAttributePoint: 2);
            creationCategory.AddCategoryOption(new TextObject("{=!}40"), new List<SkillObject>(), (CharacterAttribute)null, 0, 0, 0, (CharacterCreationOnCondition)null, new CharacterCreationOnSelect(this.StartingAgeMiddleAgedOnConsequence), new CharacterCreationApplyFinalEffects(this.StartingAgeMiddleAgedOnApply), new TextObject("{=5MxTYApM}This is the right age for starting off, you have years of experience, and you are old enough for people to respect you and gather under your banner."), unspentFocusPoint: 6, unspentAttributePoint: 3);
            creationCategory.AddCategoryOption(new TextObject("{=!}50"), new List<SkillObject>(), (CharacterAttribute)null, 0, 0, 0, (CharacterCreationOnCondition)null, new CharacterCreationOnSelect(this.StartingAgeElderlyOnConsequence), new CharacterCreationApplyFinalEffects(this.StartingAgeElderlyOnApply), new TextObject("{=ePD5Afvy}While you are past your prime, there is still enough time to go on that last big adventure for you. And you have all the experience you need to overcome anything!"), unspentFocusPoint: 8, unspentAttributePoint: 4);
            characterCreation.AddNewMenu(menu);
        }
        ...
        protected void ParentsOnInit(CharacterCreation characterCreation)
        {
            ...
            KaosesSandboxCharacterCreationContent.ClearMountEntity(characterCreation);
            ...
            List<string> actionList = new List<string>()
      {
        ...
        protected void SetParentAndOccupationType(
          CharacterCreation characterCreation,
          int parentType,
          KaosesSandboxCharacterCreationContent.OccupationTypes occupationType,
          string fatherItemId = "",
          string motherItemId = "",
          bool isLeftHandItemForFather = true,
          bool isLeftHandItemForMother = true)
            ...
            characterCreation.ChangeFaceGenChars(new List<FaceGenChar>()
      {
        ...
        protected void EmpireLandlordsRetainerOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 1, KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer);

        protected void EmpireMerchantOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 2, KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant);

        protected void EmpireFreeholderOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 3, KaosesSandboxCharacterCreationContent.OccupationTypes.Farmer);

        protected void EmpireArtisanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 4, KaosesSandboxCharacterCreationContent.OccupationTypes.Artisan);

        protected void EmpireWoodsmanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 5, KaosesSandboxCharacterCreationContent.OccupationTypes.Hunter);

        protected void EmpireVagabondOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 6, KaosesSandboxCharacterCreationContent.OccupationTypes.Vagabond);
        ...
        protected void VlandiaBaronsRetainerOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 1, KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer);

        protected void VlandiaMerchantOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 2, KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant);

        protected void VlandiaYeomanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 3, KaosesSandboxCharacterCreationContent.OccupationTypes.Farmer);

        protected void VlandiaBlacksmithOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 4, KaosesSandboxCharacterCreationContent.OccupationTypes.Artisan);

        protected void VlandiaHunterOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 5, KaosesSandboxCharacterCreationContent.OccupationTypes.Hunter);

        protected void VlandiaMercenaryOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 6, KaosesSandboxCharacterCreationContent.OccupationTypes.Mercenary);
        ...
        protected void SturgiaBoyarsCompanionOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 1, KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer);

        protected void SturgiaTraderOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 2, KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant);

        protected void SturgiaFreemanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 3, KaosesSandboxCharacterCreationContent.OccupationTypes.Farmer);

        protected void SturgiaArtisanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 4, KaosesSandboxCharacterCreationContent.OccupationTypes.Artisan);

        protected void SturgiaHunterOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 5, KaosesSandboxCharacterCreationContent.OccupationTypes.Hunter);

        protected void SturgiaVagabondOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 6, KaosesSandboxCharacterCreationContent.OccupationTypes.Vagabond);
        ...
        protected void AseraiTribesmanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 1, KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer);

        protected void AseraiWariorSlaveOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 2, KaosesSandboxCharacterCreationContent.OccupationTypes.Mercenary);

        protected void AseraiMerchantOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 3, KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant);

        protected void AseraiOasisFarmerOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 4, KaosesSandboxCharacterCreationContent.OccupationTypes.Farmer);

        protected void AseraiBedouinOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 5, KaosesSandboxCharacterCreationContent.OccupationTypes.Herder);

        protected void AseraiBackAlleyThugOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 6, KaosesSandboxCharacterCreationContent.OccupationTypes.Artisan);
        ...
        protected void BattaniaChieftainsHearthguardOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 1, KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer);

        protected void BattaniaHealerOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 2, KaosesSandboxCharacterCreationContent.OccupationTypes.Healer);

        protected void BattaniaTribesmanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 3, KaosesSandboxCharacterCreationContent.OccupationTypes.Farmer);

        protected void BattaniaSmithOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 4, KaosesSandboxCharacterCreationContent.OccupationTypes.Artisan);

        protected void BattaniaWoodsmanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 5, KaosesSandboxCharacterCreationContent.OccupationTypes.Hunter);

        protected void BattaniaBardOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 6, KaosesSandboxCharacterCreationContent.OccupationTypes.Bard);

        protected void BattaniaChieftainsHearthguardOnApply(CharacterCreation characterCreation) => this.FinalizeParents();
        ...
        protected void KhuzaitNoyansKinsmanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 1, KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer);

        protected void KhuzaitMerchantOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 2, KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant);

        protected void KhuzaitTribesmanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 3, KaosesSandboxCharacterCreationContent.OccupationTypes.Herder);

        protected void KhuzaitFarmerOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 4, KaosesSandboxCharacterCreationContent.OccupationTypes.Farmer);

        protected void KhuzaitShamanOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 5, KaosesSandboxCharacterCreationContent.OccupationTypes.Healer);

        protected void KhuzaitNomadOnConsequence(CharacterCreation characterCreation) => this.SetParentAndOccupationType(characterCreation, 6, KaosesSandboxCharacterCreationContent.OccupationTypes.Herder);
        ...
        protected void ChildhoodOnInit(CharacterCreation characterCreation)
        {
            ...
            characterCreation.HasSecondaryCharacter = false;
            characterCreation.ClearFaceGenPrefab();
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge((float)this.ChildhoodAge));
        ...
        protected static void ChildhoodSkillsWithHorsesOnConsequence(CharacterCreation characterCreation) => characterCreation.ChangeCharsAnimation(new List<string>()
    {
      "act_childhood_animals"
        ...
        protected void EducationOnInit(CharacterCreation characterCreation)
        {
            ...
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge((float)this.EducationAge));
            ...
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        ...
        protected bool RuralType() => this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Farmer || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Hunter || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Bard || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Herder || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Vagabond || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Healer || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Artisan;

        protected bool RichParents() => this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant;
            ...
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        ...
        protected void YouthOnInit(CharacterCreation characterCreation)
        {
            ...
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge((float)this.YouthAge));
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        "act_childhood_schooled"
      });
        ...
        protected bool YouthCommanderOnCondition() => this.GetSelectedCulture().StringId == "empire" && this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer;

        protected void YouthCommanderOnApply(CharacterCreation characterCreation)
        {
        }

        protected bool YouthGroomOnCondition() => this.GetSelectedCulture().StringId == "vlandia" && this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer;
            ...
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        ...
        protected bool YouthChieftainOnCondition() => (this.GetSelectedCulture().StringId == "battania" || this.GetSelectedCulture().StringId == "khuzait") && this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer;
        ...
        protected bool YouthCamperOnCondition() => this._familyOccupationType != KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer;
        ...
        protected void AccomplishmentOnInit(CharacterCreation characterCreation)
        {
            ...
            characterCreation.HasSecondaryCharacter = false;
            characterCreation.ClearFaceGenPrefab();
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge((float)this.AccomplishmentAge));
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        "act_childhood_schooled"
      });
        ...
        protected bool AccomplishmentMerchantOnCondition() => this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant;

        protected bool AccomplishmentPosseOnConditions() => this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Herder || this._familyOccupationType == KaosesSandboxCharacterCreationContent.OccupationTypes.Mercenary;

        protected bool AccomplishmentSavedVillageOnCondition() => this.RuralType() && this._familyOccupationType != KaosesSandboxCharacterCreationContent.OccupationTypes.Retainer && this._familyOccupationType != KaosesSandboxCharacterCreationContent.OccupationTypes.Herder;

        protected bool AccomplishmentSavedStreetOnCondition() => !this.RuralType() && this._familyOccupationType != KaosesSandboxCharacterCreationContent.OccupationTypes.Merchant && this._familyOccupationType != KaosesSandboxCharacterCreationContent.OccupationTypes.Mercenary;
        ...
        protected void AccomplishmentTreaterOnConsequence(CharacterCreation characterCreation) => characterCreation.ChangeCharsAnimation(new List<string>()
    {
      "act_childhood_manners"
        ...
        protected void StartingAgeOnInit(CharacterCreation characterCreation)
        {
            ...
            characterCreation.HasSecondaryCharacter = false;
            characterCreation.ClearFaceGenPrefab();
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge((float)this._startingAge));
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        "act_childhood_schooled"
      });
        ...
        {
            characterCreation.ClearFaceGenPrefab();
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge(20f));
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        "act_childhood_focus"
      });
            this.RefreshPlayerAppearance(characterCreation);
            this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.YoungAdult;
            this.SetHeroAge(20f);
        }
        ...
        {
            characterCreation.ClearFaceGenPrefab();
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge(30f));
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        "act_childhood_ready"
      });
            this.RefreshPlayerAppearance(characterCreation);
            this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.Adult;
            this.SetHeroAge(30f);
        }
        ...
        {
            characterCreation.ClearFaceGenPrefab();
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge(40f));
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        "act_childhood_sharp"
      });
            this.RefreshPlayerAppearance(characterCreation);
            this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.MiddleAged;
            this.SetHeroAge(40f);
        }
        ...
        {
            characterCreation.ClearFaceGenPrefab();
            characterCreation.ChangeFaceGenChars(KaosesSandboxCharacterCreationContent.ChangePlayerFaceWithAge(50f));
            characterCreation.ChangeCharsAnimation(new List<string>()
      {
        "act_childhood_tough"
      });
            this.RefreshPlayerAppearance(characterCreation);
            this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.Elder;
            this.SetHeroAge(50f);
        }

        protected void StartingAgeYoungOnApply(CharacterCreation characterCreation) => this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.YoungAdult;

        protected void StartingAgeAdultOnApply(CharacterCreation characterCreation) => this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.Adult;

        protected void StartingAgeMiddleAgedOnApply(CharacterCreation characterCreation) => this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.MiddleAged;

        protected void StartingAgeElderlyOnApply(CharacterCreation characterCreation) => this._startingAge = KaosesSandboxCharacterCreationContent.SandboxAgeOptions.Elder;
        ...
        protected void ApplyEquipments(CharacterCreation characterCreation)
        {
            ...
            KaosesSandboxCharacterCreationContent.ChangePlayerMount(characterCreation, Hero.MainHero);
        }
